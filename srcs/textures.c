...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/07/23 17:09:50 by anebbou           #+#    #+#             */
/*   Updated: 2025/07/23 17:10:02 by anebbou          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (!load_single_texture(cub3d, &cub3d->map.textures[0],
			cub3d->map.north_texture))
		return (0);
	if (!load_single_texture(cub3d, &cub3d->map.textures[1],
			cub3d->map.south_texture))
		return (0);
	if (!load_single_texture(cub3d, &cub3d->map.textures[2],
			cub3d->map.east_texture))
		return (0);
	if (!load_single_texture(cub3d, &cub3d->map.textures[3],
